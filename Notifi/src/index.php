...
<body>
  <main class="bg-zinc-900 w-full  flex flex-col items-center justify-start text-white font-[mulish] min-h-screen">
    <nav
      id="navbar"
      class="w-full flex justify-between items-center px-12 py-4 md:px-32 md:py-5 bg-zinc-900 fixed top-0 z-50 transition-all duration-300">
      <div class="logo">
    ...
    <section
      class="hero w-full h-[95vh] md:h-[92vh] flex flex-col items-center justify-center gap-8">
      <div
        class="bg-[#80808033] backdrop-blur-xl px-[13px] py-[5px] md:px-[23px] md:py-[7px] rounded-full text-md md:text-lg font-regular text-white text-center flex items-center gap-3 justify-center"
      ...
      <div class="hero-txt flex flex-col items-center justify-center gap-1">
        <h1 class="text-4xl md:text-6xl capitalize font-semibold tracking-normal">
      ...
      <div class="hero-para w-2/3 md:w-1/3">
        <p
      ...
      <div class="w-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 mt-0 md:mt-2 p-4">
        <div
          class="rounded-full px-5 py-2 text-sm md:px-8 md:py-3 bg-white text-black font-semibold cursor-pointer flex items-center justify-center gap-2 hover:border-[1px] hover:border-[#ffffff3d] hover:bg-transparent hover:text-white transition-colors duration-300 ease-in-out">
          <a href="./blogs.php">Explore Blogs</a>
          
          <i class="ri-news-line text-xl font-extralight"></i>
        </div>
        <div
        
          class="rounded-full px-5 py-2 text-sm md:px-8 md:py-3 border-[1px] border-[#ffffff3d] text-white font-semibold cursor-pointer flex items-center justify-center gap-2 hover:border-none hover:bg-white hover:text-black transition-colors duration-300 ease-in-out">
    ...
    <section class="w-full filler">
      <div
        class="w-full bg-[#eeeeee] text-black flex items-center gap-2 justify-center font-semibold text-xs md:text-sm tracking-[0.5px] py-[5px]">
        <p class="text-base">Proudly Backed By</p>
        <img
          src="../assets/lpu-logo-01-removebg-preview.png"
          class="w-6 h-6 md:w-8 md:h-8 object-cover"
          alt="lpulogo" />
      </div>
    </section>
    <section id="features" class="Features w-full bg-[#ffffff] text-black py-20">
      <div class="flex items-center flex-col justify-center gap-8">
        <div class="start flex items-center justify-center gap-2">
          ...
          <h1 class="font-semibold text-2xl md:text-3xl">Choice</h1>
        </div>
        <h1 class="font-medium text-[#161616] text-4xl md:text-5xl font-[gilroy] tracking-normal">No forgetting. No regrets.</h1>
      </div>
      <div class="w-full h-[10px] md:h-[60px] block"></div>
      <div class="feature-section-heading flex items-center justify-center py-4px gap-4 w-full mt-12">
        <h1 class="text-4xl md:text-5xl font-semibold text-center font-[gilroy] ">Features</h1>
        <img src="https://em-content.zobj.net/source/apple/391/star-struck_1f929.png" class="object-cover w-8 h-8 md:w-12 md:h-12" alt="">
      </div>
      <div class="feature-section flex flex-col md:flex-row items-center justify-center gap-16  px-8 py-12">
    ...
    <section class="howworks w-full px-6 py-10 md:py-20 md:px-12 flex flex-col items-start justify-center gap-4">
      <div class="flex items-start justify-center gap-2">
        <h1 class="font-semibold text-4xl md:text-5xl text-zinc-100">How it Works </h1>
        <img src="https://em-content.zobj.net/source/apple/391/thinking-face_1f914.png" alt="" class="object-cover h-8 w-8 md:w-12 md:h-12">
      </div>
      <p class=" text-[#787878] text-sm md:text-lg font-[gilroy] font-normal">No missed tasks. No excuses. </p>
      <div class="flex items-center justify-start gap-8 mt-8">
        <div class="flex flex-col font-[gilroy] gap-3 md:gap-6">
          <h1 class="text-2xl md:text-3xl font-medium  tracking-wider">01 Set It & Forget It</h1>
          <div class="border-b-1 border-[#e0614a]"></div>
          <h1 class="text-2xl md:text-3xl font-medium  tracking-wider">02 Smart Scheduling</h1>
          <div class="border-b-1 border-[#e0614a]"></div>
          <h1 class="text-2xl md:text-3xl font-medium  tracking-wider">03 Custom Alerts</h1>
          <div class="border-b-1 border-[#e0614a]"></div>
          <h1 class="text-2xl md:text-3xl font-medium  tracking-wider">04 Stay in Control</h1>
          <div class="border-b-1 border-[#e0614a]"></div>
        </div>
        <div></div>
      </div>
    ...
    <section class="w-full py-12 px-6 md:py-20 md:px-12 flex bg-[#ffffff] text-black items-center justify-center">
      <div class="rounded-md bg-zinc-200 px-5 py-8 md:px-10 md:py-16 w-full flex flex-col items-center justify-center">
        <div class="flex gap-4 items-center justify-center">
          <h1 class="capitalize text-2xl  md:text-4xl font-semibold">Unleash TimeManagment Knowledge</h1>
          <img src="https://em-content.zobj.net/source/apple/391/party-popper_1f389.png" class="object-cover w-12 h-12 hidden md:flex" alt="">
        </div>
        <div class="flex gap-6 px-4 md:px-8 flex-col md:flex-row md:py-4 py-8 justify-between mt-12">
          <div class="rounded-lg flex flex-col items-start justify-start text-start md:w-1/3 bg-zinc-100 gap-4 p-2 cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out">
    ...
    <section class="faqs w-full text-black h-[85vh] px-4 md:px-12 flex items-center justify-center bg-[#ffffff]">

      <div class="bg-zinc-100 rounded-3xl p-4 md:p-10 w-full ">
        <h2 class="text-[32px] md:text-[48px] font-medium text-[#e0614a] font-mulish leading-[120%] mb-[40px]">
          Frequently Asked Questions
        </h2>

        <div class="border-b border-gray-200 py-4">
          <div class="flex justify-between items-center">
            <p class="text-md md:text-lg">Can I customize my reminders?</p>
        ...
        <div class="border-b border-gray-200 py-4">
          <div class="flex justify-between items-center">
            <p class="text-md md:text-lg">Is my data secure?</p>
            <button class="text-[#e0614a] font-bold">+</button>
          </div>
        </div>
        ...
        <div class="border-b border-gray-200 py-4">
          <div class="flex justify-between items-center">
            <p class="text-md md:text-lg">What happens if I snooze a reminder?</p>
            <button class="text-[#e0614a] font-bold">+</button>
          </div>
        </div>
        ...
        <div class="border-b border-gray-200 py-4">
          <div class="flex justify-between items-center">
            <p class="text-md md:text-lg">Do I need to keep the app open to receive reminders?</p>
            <button class="text-[#e0614a] font-bold">+</button>
          </div>
        </div>
        ...
        <div class="py-4">
          <div class="flex justify-between items-center">
            <p class="text-md md:text-lg">How does the Smart Reminder App help me stay organized?</p>
            <button class="text-[#e0614a] font-bold">+</button>
          </div>
        </div>
      </div>
    ...
    <section class="newsletter w-full  flex  bg-[#ffffff] text-black items-center justify-center">
      <div class="w-full bg-gray-100  py-12 px-16 md:py-24 md:px-32">
